  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <Badge className={"text-[#483DFF] font-bold"} variant="ghost">
            {singleJob?.stipend}k per month
            </Badge>
          </div>
        </div>
        <Button
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Stipend: <span className="pl-4 font-medium text-gray-800">{singleJob?.stipend}k</span></h1>
